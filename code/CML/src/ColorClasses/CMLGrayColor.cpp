...
void GrayColor::fromNormedBuffer(const float* input){
  cmlGrayWithNormedInput(color, input, 1);
}
void GrayColor::toNormedBuffer(float* output) const {
  cmlNormedOutputWithGray(output, color, 1);
}
