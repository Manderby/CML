...
// The observer values of ISO-13655 are precomputed with D50. Here in CML, the
// D50 has been factored out. The original values are commented out.
...
CML_HDEF const float x2valencesISO13655[CML_X2VALENCES_ISO13655_NUM] = {
  0.0004f, 0.0013f, 0.0042f, 0.0128f, 0.0437f, 0.1363f, 0.2940f, 0.3462f, 0.3361f, 0.2913f,
  0.1984f, 0.0956f, 0.0325f, 0.0044f, 0.0096f, 0.0645f, 0.1644f, 0.2933f, 0.4341f, 0.5973f,
  0.7704f, 0.9115f, 1.0451f, 1.0630f, 1.0071f, 0.8538f, 0.6537f, 0.4455f, 0.2879f, 0.1657f,
  0.0876f, 0.0462f, 0.0234f, 0.0112f, 0.0057f, 0.0030f, 0.0015f, 0.0007f, 0.0003f, 0.0002f,
  0.0001f};
//CML_HDEF const float x2valencesISO13655[CML_X2VALENCES_ISO13655_NUM] = {
...
CML_HDEF const float y2valencesISO13655[CML_Y2VALENCES_ISO13655_NUM] = {
  0.0004f, 0.0011f, 0.0040f, 0.0121f, 0.0229f, 0.0379f, 0.0599f, 0.0922f, 0.1375f, 0.2111f,
  0.3252f, 0.5062f, 0.7160f, 0.8592f, 0.9638f, 0.9958f, 1.0000f, 0.9617f, 0.8659f, 0.7712f,
  0.6310f, 0.5055f, 0.3809f, 0.2695f, 0.1740f, 0.1086f, 0.0613f, 0.0321f, 0.0168f, 0.0085f,
  0.0040f, 0.0020f, 0.0011f, 0.0005f, 0.0002f, 0.0001f};
//CML_HDEF const float y2valencesISO13655[CML_Y2VALENCES_ISO13655_NUM] = {
...
CML_HDEF const float z2valencesISO13655[CML_Z2VALENCES_ISO13655_NUM] = {
   0.0004f, 0.0020f, 0.0056f, 0.0201f, 0.0610f, 0.2080f, 0.6548f, 1.4357f, 1.7370f, 1.7725f,
   1.6717f, 1.3057f, 0.8114f, 0.4740f, 0.2720f, 0.1581f, 0.0800f, 0.0415f, 0.0205f, 0.0088f,
   0.0039f, 0.0022f, 0.0016f, 0.0011f, 0.0008f, 0.0004f, 0.0002f, 0.0001f};
//CML_HDEF const float z2valencesISO13655[CML_Z2VALENCES_ISO13655_NUM] = {
...
CML_HDEF const float x2valencesJuddVos1978[CML_X2VALENCES_JUDDVOS1978_NUM] = {
  ...
  1.669200e-1f, 2.276800e-1f, 2.926900e-1f, 3.622500e-1f, 4.363500e-1f, 5.151300e-1f, 5.974800e-1f, 6.812100e-1f, 7.642500e-1f, 8.439400e-1f,
  9.163500e-1f, 9.770300e-1f, 1.023000e+0f, 1.051300e+0f, 1.055000e+0f, 1.036200e+0f, 9.923900e-1f, 9.286100e-1f, 8.434600e-1f, 7.398300e-1f,
  6.328900e-1f, 5.335100e-1f, 4.406200e-1f, 3.545300e-1f, 2.786200e-1f, 2.148500e-1f, 1.616100e-1f, 1.182000e-1f, 8.575300e-2f, 6.307700e-2f,
  4.583400e-2f, 3.205700e-2f, 2.218700e-2f, 1.561200e-2f, 1.109800e-2f, 7.923300e-3f, 5.653100e-3f, 4.003900e-3f, 2.825300e-3f, 1.994700e-3f,
  1.399400e-3f, 9.698000e-4f, 6.684700e-4f, 4.614100e-4f, 3.207300e-4f, 2.257300e-4f, 1.597300e-4f, 1.127500e-4f, 7.951300e-5f, 5.608700e-5f,
  3.954100e-5f, 2.785200e-5f, 1.959700e-5f, 1.377000e-5f, 9.670000e-6f, 6.791800e-6f, 4.770600e-6f, 3.355000e-6f, 2.353400e-6f, 1.637700e-6f};
...
CML_HDEF const float y2valencesJuddVos1978[CML_Y2VALENCES_JUDDVOS1978_NUM] = {
  ...
  8.620000e-1f, 9.150500e-1f, 9.540000e-1f, 9.800400e-1f, 9.949500e-1f, 1.000100e+0f, 9.950000e-1f, 9.787500e-1f, 9.520000e-1f, 9.155800e-1f,
  8.700000e-1f, 8.162300e-1f, 7.570000e-1f, 6.948300e-1f, 6.310000e-1f, 5.665400e-1f, 5.030000e-1f, 4.417200e-1f, 3.810000e-1f, 3.205200e-1f,
  2.650000e-1f, 2.170200e-1f, 1.750000e-1f, 1.381200e-1f, 1.070000e-1f, 8.165200e-2f, 6.100000e-2f, 4.432700e-2f, 3.200000e-2f, 2.345400e-2f,
  1.700000e-2f, 1.187200e-2f, 8.210000e-3f, 5.772300e-3f, 4.102000e-3f, 2.929100e-3f, 2.091000e-3f, 1.482200e-3f, 1.047000e-3f, 7.401500e-4f,
  5.200000e-4f, 3.609300e-4f, 2.492000e-4f, 1.723100e-4f, 1.200000e-4f, 8.462000e-5f, 6.000000e-5f, 4.244600e-5f, 3.000000e-5f, 2.121000e-5f,
  1.498900e-5f, 1.058400e-5f, 7.465600e-6f, 5.259200e-6f, 3.702800e-6f, 2.607600e-6f, 1.836500e-6f, 1.295000e-6f, 9.109200e-7f, 6.356400e-7f};
...
CML_HDEF const float z2valencesJuddVos1978[CML_Z2VALENCES_JUDDVOS1978_NUM] = {
  ...
  4.136600e-2f, 2.935300e-2f, 2.004200e-2f, 1.331200e-2f, 8.782300e-3f, 5.857300e-3f, 4.049300e-3f, 2.921700e-3f, 2.277100e-3f, 1.970600e-3f,
  1.806600e-3f, 1.544900e-3f, 1.234800e-3f, 1.117700e-3f, 9.056400e-4f, 6.946700e-4f, 4.288500e-4f, 3.181700e-4f, 2.559800e-4f, 1.567900e-4f,
  9.769400e-5f, 6.894400e-5f, 5.116500e-5f, 3.601600e-5f, 2.423800e-5f, 1.691500e-5f, 1.190600e-5f, 8.148900e-6f, 5.600600e-6f, 3.954400e-6f,
  2.791200e-6f, 1.917600e-6f, 1.313500e-6f, 9.151900e-7f, 6.476700e-7f, 4.635200e-7f, 3.330400e-7f, 2.382300e-7f, 1.702600e-7f, 1.220700e-7f,
  8.710700e-8f, 6.145500e-8f, 4.316200e-8f, 3.037900e-8f, 2.155400e-8f, 1.549300e-8f, 1.120400e-8f, 8.087300e-9f, 5.834000e-9f, 4.211000e-9f,
  3.038300e-9f, 2.190700e-9f, 1.577800e-9f, 1.134800e-9f, 8.156500e-10f, 5.862600e-10f, 4.213800e-10f, 3.031900e-10f, 2.175300e-10f, 1.547600e-10f};



// The following values are normalized at 555nm Y value. The original values
// are commented out.
// Step: 5 nm
...
CML_HDEF const float x2valencesShawFairchild1997[CML_X2VALENCES_SHAWFAIRCHILD1997_NUM] = {
    0.0521f,  0.1103f, 0.1829f, 0.2744f, 0.3579f, 0.3779f, 0.3645f, 0.3739f,  0.3857f,  0.3854f,
    0.3236f,  0.2546f, 0.2237f, 0.1708f, 0.1625f, 0.1092f, 0.0557f, 0.0167f, -0.0109f, -0.0215f,
   -0.0214f, -0.0112f, 0.0141f, 0.0472f, 0.0860f, 0.1378f, 0.1974f, 0.2572f,  0.3151f,  0.3784f,
    0.4509f,  0.5289f, 0.6024f, 0.6878f, 0.7879f, 0.8777f, 0.9534f, 1.0236f,  1.0810f,  1.1136f,
    1.1190f,  1.0920f, 1.0418f, 0.9674f, 0.8733f, 0.7736f, 0.6679f, 0.5519f,  0.4456f,  0.3544f,
    0.2744f,  0.2048f, 0.1499f, 0.1090f, 0.0795f, 0.0565f, 0.0385f, 0.0273f,  0.0195f,  0.0134f,
    0.0085f};
//CML_HDEF const float x2valencesShawFairchild1997[CML_X2VALENCES_SHAWFAIRCHILD1997_NUM] = {
...
CML_HDEF const float y2valencesShawFairchild1997[CML_Y2VALENCES_SHAWFAIRCHILD1997_NUM] = {
  0.0008f, 0.0011f, 0.0012f, -0.0006f, -0.0016f, -0.0053f, -0.0063f, -0.0052f, -0.0005f, 0.0045f,
  0.0152f, 0.0298f, 0.0498f,  0.0812f,  0.1180f,  0.1595f,  0.1970f,  0.2352f,  0.2805f, 0.3423f,
  0.4155f, 0.5012f, 0.5891f,  0.6795f,  0.7687f,  0.8417f,  0.8991f,  0.9384f,  0.9609f, 0.9836f,
  0.9995f, 1.0000f, 0.9832f,  0.9705f,  0.9646f,  0.9334f,  0.8866f,  0.8477f,  0.8035f, 0.7466f,
  0.6843f, 0.6197f, 0.5519f,  0.4827f,  0.4156f,  0.3529f,  0.2933f,  0.2370f,  0.1884f, 0.1477f,
  0.1133f, 0.0848f, 0.0624f,  0.0453f,  0.0327f,  0.0233f,  0.0164f,  0.0116f,  0.0082f, 0.0057f,
  0.0038f};
//CML_HDEF const float y2valencesShawFairchild1997[CML_Y2VALENCES_SHAWFAIRCHILD1997_NUM] = {
...
CML_HDEF const float z2valencesShawFairchild1997[CML_Z2VALENCES_SHAWFAIRCHILD1997_NUM] = {
   0.2014f,  0.3888f,  0.6519f,  1.0258f,  1.4132f,  1.6042f,  1.6921f,  1.8133f,  1.8925f,  1.8715f,
   1.7302f,  1.5525f,  1.4089f,  1.3054f,  1.1911f,  0.9791f,  0.7604f,  0.5805f,  0.4374f,  0.3327f,
   0.2538f,  0.1972f,  0.1516f,  0.1208f,  0.0988f,  0.0810f,  0.0679f,  0.0575f,  0.0489f,  0.0410f,
   0.0344f,  0.0280f,  0.0225f,  0.0175f,  0.0121f,  0.0064f,  0.0006f, -0.0046f, -0.0094f, -0.0136f,
  -0.0167f, -0.0188f, -0.0198f, -0.0199f, -0.0191f, -0.0175f, -0.0154f, -0.0132f, -0.0109f, -0.0089f,
  -0.0070f, -0.0054f, -0.0040f, -0.0030f, -0.0022f, -0.0016f, -0.0011f, -0.0008f, -0.0005f, -0.0004f,
  -0.0003f};
//CML_HDEF const float z2valencesShawFairchild1997[CML_Z2VALENCES_SHAWFAIRCHILD1997_NUM] = {
...
CML_HDEF void cml_recomputeObserver(CMLColorMachine* cm){
  if(cm->recomputationLockCount){
    cm->recomputationMask |= CML_COLORMACHINE_RECOMPUTE_OBSERVER;
    return;
  }
...
CML_DEF void cmlCreateSpecDistFunctions(CMLFunction* functions[3], CMLObserverType observerType){
  switch(observerType){
  case CML_OBSERVER_2DEG_CIE_1931: {
    CMLArrayFunctionInput inputX = {
      x2valencesCIE1931,
      CML_FALSE,
      { CML_X2VALENCES_CIE1931_NUM,
        CML_X2VALENCES_CIE1931_MIN,
        CML_X2VALENCES_CIE1931_MAX,
    ...
    CMLArrayFunctionInput inputY = {
      y2valencesCIE1931,
      CML_FALSE,
      { CML_Y2VALENCES_CIE1931_NUM,
        CML_Y2VALENCES_CIE1931_MIN,
        CML_Y2VALENCES_CIE1931_MAX,
        CML_INTERPOLATION_LINEAR,
        CML_EXTRAPOLATION_LINEAR_ZERO,
        CML_EXTRAPOLATION_LINEAR_ZERO}};
    ...
    CMLArrayFunctionInput inputZ = {
      z2valencesCIE1931,
      CML_FALSE,
      { CML_Z2VALENCES_CIE1931_NUM,
        CML_Z2VALENCES_CIE1931_MIN,
        CML_Z2VALENCES_CIE1931_MAX,
        CML_INTERPOLATION_LINEAR,
        CML_EXTRAPOLATION_LINEAR_ZERO,
        CML_EXTRAPOLATION_LINEAR_ZERO}};
  ...
  case CML_OBSERVER_10DEG_CIE_1964: {
    CMLArrayFunctionInput inputX = {
      x10valencesCIE1964,
      CML_FALSE,
      { CML_X10VALENCES_CIE1964_NUM,
        CML_X10VALENCES_CIE1964_MIN,
        CML_X10VALENCES_CIE1964_MAX,
        CML_INTERPOLATION_LINEAR,
        CML_EXTRAPOLATION_LINEAR_ZERO,
        CML_EXTRAPOLATION_LINEAR_ZERO}};
    functions[0] = cmlCreateArrayFunction(inputX);
    CMLArrayFunctionInput inputY = {
      y10valencesCIE1964,
      CML_FALSE,
      { CML_Y10VALENCES_CIE1964_NUM,
        CML_Y10VALENCES_CIE1964_MIN,
        CML_Y10VALENCES_CIE1964_MAX,
        CML_INTERPOLATION_LINEAR,
        CML_EXTRAPOLATION_LINEAR_ZERO,
        CML_EXTRAPOLATION_LINEAR_ZERO}};
    functions[1] = cmlCreateArrayFunction(inputY);
    CMLArrayFunctionInput inputZ = {
      z10valencesCIE1964,
      CML_FALSE,
      { CML_Z10VALENCES_CIE1964_NUM,
        CML_Z10VALENCES_CIE1964_MIN,
        CML_Z10VALENCES_CIE1964_MAX,
        CML_INTERPOLATION_LINEAR,
        CML_EXTRAPOLATION_LINEAR_ZERO,
        CML_EXTRAPOLATION_LINEAR_ZERO}};
    functions[2] = cmlCreateArrayFunction(inputZ);
  ...
  case CML_OBSERVER_2DEG_JUDD_1951: {
      ...
      x2valencesJudd1951,
      CML_FALSE,
      {CML_X2VALENCES_JUDD1951_NUM,
        CML_X2VALENCES_JUDD1951_MIN,
        CML_X2VALENCES_JUDD1951_MAX,
        CML_INTERPOLATION_LINEAR,
        CML_EXTRAPOLATION_LINEAR_ZERO,
        CML_EXTRAPOLATION_LINEAR_ZERO}};
    functions[0] = cmlCreateArrayFunction(inputX);
      ...
      y2valencesJudd1951,
      CML_FALSE,
      { CML_Y2VALENCES_JUDD1951_NUM,
        CML_Y2VALENCES_JUDD1951_MIN,
        CML_Y2VALENCES_JUDD1951_MAX,
        CML_INTERPOLATION_LINEAR,
        CML_EXTRAPOLATION_LINEAR_ZERO,
        CML_EXTRAPOLATION_LINEAR_ZERO}};
    functions[1] = cmlCreateArrayFunction(inputY);
      ...
      z2valencesJudd1951,
      CML_FALSE,
      { CML_Z2VALENCES_JUDD1951_NUM,
        CML_Z2VALENCES_JUDD1951_MIN,
        CML_Z2VALENCES_JUDD1951_MAX,
        CML_INTERPOLATION_LINEAR,
        CML_EXTRAPOLATION_LINEAR_ZERO,
        CML_EXTRAPOLATION_LINEAR_ZERO}};
    functions[2] = cmlCreateArrayFunction(inputZ);
  ...
  case CML_OBSERVER_2DEG_JUDD_VOS_1978: {
    CMLArrayFunctionInput inputX = {
      x2valencesJuddVos1978,
      CML_FALSE,
      { CML_X2VALENCES_JUDDVOS1978_NUM,
        CML_X2VALENCES_JUDDVOS1978_MIN,
        CML_X2VALENCES_JUDDVOS1978_MAX,
        CML_INTERPOLATION_LINEAR,
        CML_EXTRAPOLATION_LINEAR_ZERO,
        CML_EXTRAPOLATION_LINEAR_ZERO}};
    functions[0] = cmlCreateArrayFunction(inputX);
    CMLArrayFunctionInput inputY = {
      y2valencesJuddVos1978,
      CML_FALSE,
      { CML_Y2VALENCES_JUDDVOS1978_NUM,
        CML_Y2VALENCES_JUDDVOS1978_MIN,
        CML_Y2VALENCES_JUDDVOS1978_MAX,
        CML_INTERPOLATION_LINEAR,
        CML_EXTRAPOLATION_LINEAR_ZERO,
        CML_EXTRAPOLATION_LINEAR_ZERO}};
    functions[1] = cmlCreateArrayFunction(inputY);
    CMLArrayFunctionInput inputZ = {
      z2valencesJuddVos1978,
      CML_FALSE,
      { CML_Z2VALENCES_JUDDVOS1978_NUM,
        CML_Z2VALENCES_JUDDVOS1978_MIN,
        CML_Z2VALENCES_JUDDVOS1978_MAX,
        CML_INTERPOLATION_LINEAR,
        CML_EXTRAPOLATION_LINEAR_ZERO,
        CML_EXTRAPOLATION_LINEAR_ZERO}};
    functions[2] = cmlCreateArrayFunction(inputZ);
...
CML_HDEF void cml_ClearObserver(CMLColorMachine* cm, CMLObserver* observer){
...
CML_HDEF CMLObserverType cml_GetObserverType(const CMLObserver* observer){
  return observer->type;
}

CML_DEF CMLObserverType cmlGetObserverType(const CMLColorMachine* cm){
  return cml_GetObserverType(&(cm->observer));
}



CML_DEF float cmlGetRadiometricScale(const CMLColorMachine* cm){
  return cm->radiometricScale;
}



CML_DEF float cmlGetColorimetricBase(const CMLColorMachine* cm){
...
CML_DEF const CMLFunction* cmlGetSpecDistFunction(const CMLColorMachine* cm, int index){
  return cml_GetObserverSpecDistFunction(&(cm->observer), index);
}
