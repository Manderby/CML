...
CML_HDEF static const CMLIlluminationType rgbSpaceIlluminations[CML_RGB_COUNT] = {
  ...
  CML_ILLUMINATION_D50_ISO, // CML_RGB_BEST
  CML_ILLUMINATION_D50_ISO, // CML_RGB_BETA
  CML_ILLUMINATION_D65,     // CML_RGB_BRUCE
  CML_ILLUMINATION_E,       // CML_RGB_CIE
  CML_ILLUMINATION_D50_ISO, // CML_RGB_COLORMATCH
  CML_ILLUMINATION_D50_ISO, // CML_RGB_DON4
  CML_ILLUMINATION_D50_ISO, // CML_RGB_EBU_MONITOR
  CML_ILLUMINATION_D50_ISO, // CML_RGB_ECI
  CML_ILLUMINATION_D50_ISO, // CML_RGB_EKTA_SPACE_PS5
