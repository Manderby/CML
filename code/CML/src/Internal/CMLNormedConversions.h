...
CML_HIDEF void cml_NormedInputToYcd(float* CML_RESTRICT ycd, const float* CML_RESTRICT input){
...
CML_HIDEF void cml_YcdToNormedOutput(float* CML_RESTRICT output, const float* CML_RESTRICT ycd){
