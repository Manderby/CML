...
CML_HIDDEN CML_INLINE static CMLBool cml_ClampToRange(float* x, float a, float b){
...
CML_HIDDEN CML_INLINE static void cml_ClampGray(float* gray){
  cml_ClampToRange(&(gray[0]), CML_GRAY_MIN, CML_GRAY_MAX);
}

CML_HIDDEN CML_INLINE static void cml_ClampXYZ(float* xyz){
...
CML_HIDDEN CML_INLINE static void cml_ClampYxy(float* yxy){
...
CML_HIDDEN CML_INLINE static void cml_ClampYuv(float* yuv){
...
CML_HIDDEN CML_INLINE static void cml_ClampYupvp(float* yuv){
...
CML_HIDDEN CML_INLINE static void cml_ClampLab(float* lab){
...
CML_HIDDEN CML_INLINE static void cml_ClampLch(float* lch){
  CMLint32 fullangles;
...
CML_HIDDEN CML_INLINE static void cml_ClampLuv(float* luv){
...
CML_HIDDEN CML_INLINE static void cml_ClampRGB(float* rgb){
...
CML_HIDDEN CML_INLINE static void cml_ClampYCbCr(float* ycbcr){
...
CML_HIDDEN CML_INLINE static void cml_ClampHSV(float* hsv){
...
CML_HIDDEN CML_INLINE static void cml_ClampHSL(float* hsl){
...
CML_HIDDEN CML_INLINE static void cml_ClampCMYK(float* cmyk){
