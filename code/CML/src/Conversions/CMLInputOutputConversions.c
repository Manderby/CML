...
//
//
//CML_HIDDEN CML_INLINE void CMLInternal8bittofloat(float* out, CMLByte in, CMLByte offset, float range){
//  *out = (float)(in - offset) / range;
//}
//CML_HIDDEN CML_INLINE void CMLInternal16bittofloat(float* out, CMLWord in, CMLWord offset, float range){
//  *out = (float)(in - offset) / range;
//}
//
//
//CML_HIDDEN CML_INLINE void CMLInternal8bittofloat1(const CMLColorMachine* cm, float* CML_RESTRICT out, const CMLByte* CML_RESTRICT in){
//  CMLInternal8bittofloat(&(out[0]), in[0], cm->inputoutput.offset8bit[0], cm->inputoutput.range8bit[0]);
//}
//CML_HIDDEN CML_INLINE void CMLInternal8bittofloat3(const CMLColorMachine* cm, float* CML_RESTRICT out, const CMLByte* CML_RESTRICT in){
//  CMLInternal8bittofloat(&(out[0]), in[0], cm->inputoutput.offset8bit[0], cm->inputoutput.range8bit[0]);
...
//}
//CML_HIDDEN CML_INLINE void CMLInternal8bittofloat4(const CMLColorMachine* cm, float* CML_RESTRICT out, const CMLByte* CML_RESTRICT in){
//  CMLInternal8bittofloat(&(out[0]), in[0], cm->inputoutput.offset8bit[0], cm->inputoutput.range8bit[0]);
//  CMLInternal8bittofloat(&(out[1]), in[1], cm->inputoutput.offset8bit[1], cm->inputoutput.range8bit[1]);
//  CMLInternal8bittofloat(&(out[2]), in[2], cm->inputoutput.offset8bit[2], cm->inputoutput.range8bit[2]);
...
//
//
//CML_HIDDEN CML_INLINE void CMLInternal16bittofloat1(const CMLColorMachine* cm, float* CML_RESTRICT out, const CMLWord* CML_RESTRICT in){
//  CMLInternal16bittofloat(&(out[0]), in[0], cm->inputoutput.offset16bit[0], cm->inputoutput.range16bit[0]);
//}
//CML_HIDDEN CML_INLINE void CMLInternal16bittofloat3(const CMLColorMachine* cm, float* CML_RESTRICT out, const CMLWord* CML_RESTRICT in){
//  CMLInternal16bittofloat(&(out[0]), in[0], cm->inputoutput.offset16bit[0], cm->inputoutput.range16bit[0]);
...
//}
//CML_HIDDEN CML_INLINE void CMLInternal16bittofloat4(const CMLColorMachine* cm, float* CML_RESTRICT out, const CMLWord* CML_RESTRICT in){
//  CMLInternal16bittofloat(&(out[0]), in[0], cm->inputoutput.offset16bit[0], cm->inputoutput.range16bit[0]);
//  CMLInternal16bittofloat(&(out[1]), in[1], cm->inputoutput.offset16bit[1], cm->inputoutput.range16bit[1]);
//  CMLInternal16bittofloat(&(out[2]), in[2], cm->inputoutput.offset16bit[2], cm->inputoutput.range16bit[2]);
...
//
//
//CML_HIDDEN CML_INLINE void CMLInternalfloatto8bitFloor(CMLByte* out, float in, CMLByte offset, float range){
//  *out = offset + (CMLByte)(in*range);
//}
//CML_HIDDEN CML_INLINE void CMLInternalfloatto16bitFloor(CMLWord* out, float in, CMLWord offset, float range){
//  *out = offset + (CMLByte)(in*range);
//}
//CML_HIDDEN CML_INLINE void CMLInternalfloatto8bitBox(CMLByte* out, float in, CMLByte offset, float range){
//  *out = offset + (CMLByte)(in*range + .5f);
//}
//CML_HIDDEN CML_INLINE void CMLInternalfloatto16bitBox(CMLWord* out, float in, CMLWord offset, float range){
//  *out = offset + (CMLByte)(in*range + .5f);
//}
//CML_HIDDEN CML_INLINE void CMLInternalfloatto8bitInterval(CMLByte* out, float in, CMLByte offset, float range){
//  *out = offset + ((in == 1.f) ? (CMLByte)range : (CMLByte)(in*(range + 1.f)));
//}
//CML_HIDDEN CML_INLINE void CMLInternalfloatto16bitInterval(CMLWord* out, float in, CMLWord offset, float range){
