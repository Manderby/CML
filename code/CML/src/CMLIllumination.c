...
CML_API CMLMOBFunction* cmlCreateIlluminationSpectrum(CMLIlluminationType illuminationtype, float temperature){  
  ...
  case CML_ILLUMINATION_B:
    return cmlCreateConstArrayFunction(billuminant, CML_ILLUMINATIONSPECTRUM_NUM, CML_ILLUMINATIONSPECTRUM_MIN, CML_ILLUMINATIONSPECTRUM_MAX, CML_INTERPOLATION_LINEAR, CML_EXTRAPOLATION_LINEAR_ZERO, CML_EXTRAPOLATION_LINEAR_ZERO);
    break;
  case CML_ILLUMINATION_C:
    return cmlCreateConstArrayFunction(cilluminant, CML_ILLUMINATIONSPECTRUM_NUM, CML_ILLUMINATIONSPECTRUM_MIN, CML_ILLUMINATIONSPECTRUM_MAX, CML_INTERPOLATION_LINEAR, CML_EXTRAPOLATION_LINEAR_ZERO, CML_EXTRAPOLATION_LINEAR_ZERO);
    break;
  ...
  case CML_ILLUMINATION_F1:
    return cmlCreateConstArrayFunction(f1illuminant, CML_ILLUMINATIONSPECTRUM_NUM, CML_ILLUMINATIONSPECTRUM_MIN, CML_ILLUMINATIONSPECTRUM_MAX, CML_INTERPOLATION_LINEAR, CML_EXTRAPOLATION_LINEAR_ZERO, CML_EXTRAPOLATION_LINEAR_ZERO);
    break;
  case CML_ILLUMINATION_F2:
    return cmlCreateConstArrayFunction(f2illuminant, CML_ILLUMINATIONSPECTRUM_NUM, CML_ILLUMINATIONSPECTRUM_MIN, CML_ILLUMINATIONSPECTRUM_MAX, CML_INTERPOLATION_LINEAR, CML_EXTRAPOLATION_LINEAR_ZERO, CML_EXTRAPOLATION_LINEAR_ZERO);
    break;
  case CML_ILLUMINATION_F3:
    return cmlCreateConstArrayFunction(f3illuminant, CML_ILLUMINATIONSPECTRUM_NUM, CML_ILLUMINATIONSPECTRUM_MIN, CML_ILLUMINATIONSPECTRUM_MAX, CML_INTERPOLATION_LINEAR, CML_EXTRAPOLATION_LINEAR_ZERO, CML_EXTRAPOLATION_LINEAR_ZERO);
    break;
  case CML_ILLUMINATION_F4:
    return cmlCreateConstArrayFunction(f4illuminant, CML_ILLUMINATIONSPECTRUM_NUM, CML_ILLUMINATIONSPECTRUM_MIN, CML_ILLUMINATIONSPECTRUM_MAX, CML_INTERPOLATION_LINEAR, CML_EXTRAPOLATION_LINEAR_ZERO, CML_EXTRAPOLATION_LINEAR_ZERO);
    break;
  case CML_ILLUMINATION_F5:
    return cmlCreateConstArrayFunction(f5illuminant, CML_ILLUMINATIONSPECTRUM_NUM, CML_ILLUMINATIONSPECTRUM_MIN, CML_ILLUMINATIONSPECTRUM_MAX, CML_INTERPOLATION_LINEAR, CML_EXTRAPOLATION_LINEAR_ZERO, CML_EXTRAPOLATION_LINEAR_ZERO);
    break;
  case CML_ILLUMINATION_F6:
    return cmlCreateConstArrayFunction(f6illuminant, CML_ILLUMINATIONSPECTRUM_NUM, CML_ILLUMINATIONSPECTRUM_MIN, CML_ILLUMINATIONSPECTRUM_MAX, CML_INTERPOLATION_LINEAR, CML_EXTRAPOLATION_LINEAR_ZERO, CML_EXTRAPOLATION_LINEAR_ZERO);
    break;
  case CML_ILLUMINATION_F7:
    return cmlCreateConstArrayFunction(f7illuminant, CML_ILLUMINATIONSPECTRUM_NUM, CML_ILLUMINATIONSPECTRUM_MIN, CML_ILLUMINATIONSPECTRUM_MAX, CML_INTERPOLATION_LINEAR, CML_EXTRAPOLATION_LINEAR_ZERO, CML_EXTRAPOLATION_LINEAR_ZERO);
    break;
  case CML_ILLUMINATION_F8:
    return cmlCreateConstArrayFunction(f8illuminant, CML_ILLUMINATIONSPECTRUM_NUM, CML_ILLUMINATIONSPECTRUM_MIN, CML_ILLUMINATIONSPECTRUM_MAX, CML_INTERPOLATION_LINEAR, CML_EXTRAPOLATION_LINEAR_ZERO, CML_EXTRAPOLATION_LINEAR_ZERO);
    break;
  case CML_ILLUMINATION_F9:
    return cmlCreateConstArrayFunction(f9illuminant, CML_ILLUMINATIONSPECTRUM_NUM, CML_ILLUMINATIONSPECTRUM_MIN, CML_ILLUMINATIONSPECTRUM_MAX, CML_INTERPOLATION_LINEAR, CML_EXTRAPOLATION_LINEAR_ZERO, CML_EXTRAPOLATION_LINEAR_ZERO);
    break;
  case CML_ILLUMINATION_F10:
    return cmlCreateConstArrayFunction(f10illuminant, CML_ILLUMINATIONSPECTRUM_NUM, CML_ILLUMINATIONSPECTRUM_MIN, CML_ILLUMINATIONSPECTRUM_MAX, CML_INTERPOLATION_LINEAR, CML_EXTRAPOLATION_LINEAR_ZERO, CML_EXTRAPOLATION_LINEAR_ZERO);
    break;
  case CML_ILLUMINATION_F11:
    return cmlCreateConstArrayFunction(f11illuminant, CML_ILLUMINATIONSPECTRUM_NUM, CML_ILLUMINATIONSPECTRUM_MIN, CML_ILLUMINATIONSPECTRUM_MAX, CML_INTERPOLATION_LINEAR, CML_EXTRAPOLATION_LINEAR_ZERO, CML_EXTRAPOLATION_LINEAR_ZERO);
    break;
  case CML_ILLUMINATION_F12:
    return cmlCreateConstArrayFunction(f12illuminant, CML_ILLUMINATIONSPECTRUM_NUM, CML_ILLUMINATIONSPECTRUM_MIN, CML_ILLUMINATIONSPECTRUM_MAX, CML_INTERPOLATION_LINEAR, CML_EXTRAPOLATION_LINEAR_ZERO, CML_EXTRAPOLATION_LINEAR_ZERO);
    break;
  case CML_ILLUMINATION_XENON:
    return cmlCreateConstArrayFunction(xenonilluminant, CML_XENON_ILLUMINATIONSPECTRUM_NUM, CML_XENON_ILLUMINATIONSPECTRUM_MIN, CML_XENON_ILLUMINATIONSPECTRUM_MAX, CML_INTERPOLATION_LINEAR, CML_EXTRAPOLATION_LINEAR_ZERO, CML_EXTRAPOLATION_LINEAR_ZERO);
    break;
  default:
    #ifndef NDEBUG
...
CML_API float cmlComputeCorrelatedColorTemperature(const CMLVec3 whiteYuv){
  float temperature = 0.f;
  CMLSize i;
  float dm = 0.f;

  for(i = 0; i < CML_ROBERTSON_SAMPLECOUNT; i++) {
    float di = (whiteYuv[2] - robertsonv[i]) - robertsont[i] * (whiteYuv[1] - robertsonu[i]);
    if ((i > 0) && (di*dm < 0.f)){
      float p;
...
void cmlUpdateIlluminationSpectrum(void* listener, const void* sender){
  CML_UNUSED(listener);
  CML_UNUSED(sender);
}
...
CML_API CMLIllumination* cmlCreateIlluminationWithPreset(CMLIlluminationType type, float temperature){
  CMLIllumination* illumination = (CMLIllumination*)mobCreateObject(cml_Key(CML_ILLUMINATION_OBJECT));
  ...
  cmlRetainCMOB(illumination->spectrum, illumination, cmlUpdateIlluminationSpectrum);
...
//      CMLVec3 whiteYuv;
//      cml_OneYupvpToYuv(whiteYuv, cm->illumination.whiteYupvp);
//      cm->illumination.temperature = cmlComputeCorrelatedColorTemperature(whiteYuv);
    }
    break;
  }
  return illumination;
...
CML_API CMLIllumination* cmlCreateIlluminationWithCustomSpectrum(const CMLMOBFunction* spectrum){
  ...
  illumination->temperature = 0.f;
  illumination->spectrum = (CMLMOBFunction*)cmlRetainCMOB(spectrum, illumination, CML_NULL);
  cmlRetainCMOB(illumination->spectrum, illumination, cmlUpdateIlluminationSpectrum);
...
//  CMLIllumination* illumination = (CMLIllumination*)mobCreateObject(cml_Key(CML_ILLUMINATION_OBJECT));
//  illumination->type = CML_ILLUMINATION_CUSTOM_Yxy;
//  illumination->spectrum = NULL;
//  
//  cml_OneYxyToXYZ(illumination->radiometricXYZ, whiteYxy, CML_NULL);
//
//  CMLVec3 whiteYupvp;
//  CMLVec3 whiteYuv;
//  cml_OneYxyToYupvp(&(whiteYupvp[0]), &(whiteYupvp[1]), &(whiteYupvp[2]), &(whiteYxy[0]), &(whiteYxy[1]), &(whiteYxy[2]), CML_NULL);
//  cml_OneYupvpToYuv(whiteYuv, whiteYupvp);
//  illumination->temperature = cmlComputeCorrelatedColorTemperature(whiteYuv);
//
//  return illumination;
//}
