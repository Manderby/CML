...
CMLHIDDEN static const float x2valencesCIE1931[CML_X2VALENCES_CIE1931_NUM] = {
...
CMLHIDDEN static const float y2valencesCIE1931[CML_Y2VALENCES_CIE1931_NUM] = {
...
CMLHIDDEN static const float z2valencesCIE1931[CML_Z2VALENCES_CIE1931_NUM] = {
...
CMLHIDDEN static const float x10valencesCIE1964[CML_X10VALENCES_CIE1964_NUM] = {
...
CMLHIDDEN static const float y10valencesCIE1964[CML_Y10VALENCES_CIE1964_NUM] = {
...
CMLHIDDEN static const float z10valencesCIE1964[CML_Z10VALENCES_CIE1964_NUM] = {
...
CMLHIDDEN static const float x2valencesJudd1951[CML_X2VALENCES_JUDD1951_NUM] = {
...
CMLHIDDEN static const float y2valencesJudd1951[CML_Y2VALENCES_JUDD1951_NUM] = {
...
CMLHIDDEN static const float z2valencesJudd1951[CML_Z2VALENCES_JUDD1951_NUM] = {
...
CMLHIDDEN static const float x2valencesJuddVos1978[CML_X2VALENCES_JUDDVOS1978_NUM] = {
...
CMLHIDDEN static const float y2valencesJuddVos1978[CML_Y2VALENCES_JUDDVOS1978_NUM] = {
...
CMLHIDDEN static const float z2valencesJuddVos1978[CML_Z2VALENCES_JUDDVOS1978_NUM] = {
...
CMLHIDDEN static const float x2valencesShawFairchild1997[CML_X2VALENCES_SHAWFAIRCHILD1997_NUM] = {
...
CMLHIDDEN static const float y2valencesShawFairchild1997[CML_Y2VALENCES_SHAWFAIRCHILD1997_NUM] = {
...
CMLHIDDEN static const float z2valencesShawFairchild1997[CML_Z2VALENCES_SHAWFAIRCHILD1997_NUM] = {
...
CMLAPI void cmlCreateSpecDistFunctions(CMLFunction* functions[3], CMLObserverType observer){
  switch(observer){
//  case CML_OBSERVER_2DEG_1931:
//    functions[0] = new CMLArrayFunction(CML_X2VALENCES_1931_MIN, CML_X2VALENCES_1931_MAX, CMLArray(x2valences1931, CMLFALSE, CML_X2VALENCES_1931_NUM), CML_INTERPOLATION_LINEAR, CML_EXTRAPOLATION_LINEAR_ZERO);
//    functions[1] = new CMLArrayFunction(CML_Y2VALENCES_1931_MIN, CML_Y2VALENCES_1931_MAX, CMLArray(y2valences1931, CMLFALSE, CML_Y2VALENCES_1931_NUM), CML_INTERPOLATION_LINEAR, CML_EXTRAPOLATION_LINEAR_ZERO);
//    functions[2] = new CMLArrayFunction(CML_Z2VALENCES_1931_MIN, CML_Z2VALENCES_1931_MAX, CMLArray(z2valences1931, CMLFALSE, CML_Z2VALENCES_1931_NUM), CML_INTERPOLATION_LINEAR, CML_EXTRAPOLATION_LINEAR_ZERO);
//    break;
//  case CML_OBSERVER_10DEG_1964:
//    functions[0] = new CMLArrayFunction(CML_X10VALENCES_1964_MIN, CML_X10VALENCES_1964_MAX, CMLArray(x10valences1964, CMLFALSE, CML_X10VALENCES_1964_NUM), CML_INTERPOLATION_LINEAR, CML_EXTRAPOLATION_LINEAR_ZERO);
//    functions[1] = new CMLArrayFunction(CML_Y10VALENCES_1964_MIN, CML_Y10VALENCES_1964_MAX, CMLArray(y10valences1964, CMLFALSE, CML_Y10VALENCES_1964_NUM), CML_INTERPOLATION_LINEAR, CML_EXTRAPOLATION_LINEAR_ZERO);
//    functions[2] = new CMLArrayFunction(CML_Z10VALENCES_1964_MIN, CML_Z10VALENCES_1964_MAX, CMLArray(z10valences1964, CMLFALSE, CML_Z10VALENCES_1964_NUM), CML_INTERPOLATION_LINEAR, CML_EXTRAPOLATION_LINEAR_ZERO);
//    break;
  case CML_OBSERVER_2DEG_CIE_1931:
    functions[0] = CMLcreateArrayFunction(x2valencesCIE1931, CMLFALSE, CML_X2VALENCES_CIE1931_NUM, CML_X2VALENCES_CIE1931_MIN, CML_X2VALENCES_CIE1931_MAX, CML_INTERPOLATION_LINEAR, CML_EXTRAPOLATION_LINEAR_ZERO, CML_EXTRAPOLATION_LINEAR_ZERO);
    functions[1] = CMLcreateArrayFunction(y2valencesCIE1931, CMLFALSE, CML_Y2VALENCES_CIE1931_NUM, CML_Y2VALENCES_CIE1931_MIN, CML_Y2VALENCES_CIE1931_MAX, CML_INTERPOLATION_LINEAR, CML_EXTRAPOLATION_LINEAR_ZERO, CML_EXTRAPOLATION_LINEAR_ZERO);
    functions[2] = CMLcreateArrayFunction(z2valencesCIE1931, CMLFALSE, CML_Z2VALENCES_CIE1931_NUM, CML_Z2VALENCES_CIE1931_MIN, CML_Z2VALENCES_CIE1931_MAX, CML_INTERPOLATION_LINEAR, CML_EXTRAPOLATION_LINEAR_ZERO, CML_EXTRAPOLATION_LINEAR_ZERO);
    break;
  case CML_OBSERVER_10DEG_CIE_1964:
    functions[0] = CMLcreateArrayFunction(x10valencesCIE1964, CMLFALSE, CML_X10VALENCES_CIE1964_NUM, CML_X10VALENCES_CIE1964_MIN, CML_X10VALENCES_CIE1964_MAX, CML_INTERPOLATION_LINEAR, CML_EXTRAPOLATION_LINEAR_ZERO, CML_EXTRAPOLATION_LINEAR_ZERO);
    functions[1] = CMLcreateArrayFunction(y10valencesCIE1964, CMLFALSE, CML_Y10VALENCES_CIE1964_NUM, CML_Y10VALENCES_CIE1964_MIN, CML_Y10VALENCES_CIE1964_MAX, CML_INTERPOLATION_LINEAR, CML_EXTRAPOLATION_LINEAR_ZERO, CML_EXTRAPOLATION_LINEAR_ZERO);
    functions[2] = CMLcreateArrayFunction(z10valencesCIE1964, CMLFALSE, CML_Z10VALENCES_CIE1964_NUM, CML_Z10VALENCES_CIE1964_MIN, CML_Z10VALENCES_CIE1964_MAX, CML_INTERPOLATION_LINEAR, CML_EXTRAPOLATION_LINEAR_ZERO, CML_EXTRAPOLATION_LINEAR_ZERO);
    break;
//  case CML_OBSERVER_2DEG_ISO_13655:
//    functions[0] = CMLcreateArrayFunction(x2valencesISO13655, CMLFALSE, CML_X2VALENCES_ISO13655_NUM, CML_X2VALENCES_ISO13655_MIN, CML_X2VALENCES_ISO13655_MAX, CML_INTERPOLATION_LINEAR, CML_EXTRAPOLATION_LINEAR_ZERO, CML_EXTRAPOLATION_LINEAR_ZERO);
//    functions[1] = CMLcreateArrayFunction(y2valencesISO13655, CMLFALSE, CML_Y2VALENCES_ISO13655_NUM, CML_Y2VALENCES_ISO13655_MIN, CML_Y2VALENCES_ISO13655_MAX, CML_INTERPOLATION_LINEAR, CML_EXTRAPOLATION_LINEAR_ZERO, CML_EXTRAPOLATION_LINEAR_ZERO);
//    functions[2] = CMLcreateArrayFunction(z2valencesISO13655, CMLFALSE, CML_Z2VALENCES_ISO13655_NUM, CML_Z2VALENCES_ISO13655_MIN, CML_Z2VALENCES_ISO13655_MAX, CML_INTERPOLATION_LINEAR, CML_EXTRAPOLATION_LINEAR_ZERO, CML_EXTRAPOLATION_LINEAR_ZERO);
//    break;
  case CML_OBSERVER_2DEG_JUDD_1951:
    functions[0] = CMLcreateArrayFunction(x2valencesJudd1951, CMLFALSE, CML_X2VALENCES_JUDD1951_NUM, CML_X2VALENCES_JUDD1951_MIN, CML_X2VALENCES_JUDD1951_MAX, CML_INTERPOLATION_LINEAR, CML_EXTRAPOLATION_LINEAR_ZERO, CML_EXTRAPOLATION_LINEAR_ZERO);
    functions[1] = CMLcreateArrayFunction(y2valencesJudd1951, CMLFALSE, CML_Y2VALENCES_JUDD1951_NUM, CML_Y2VALENCES_JUDD1951_MIN, CML_Y2VALENCES_JUDD1951_MAX, CML_INTERPOLATION_LINEAR, CML_EXTRAPOLATION_LINEAR_ZERO, CML_EXTRAPOLATION_LINEAR_ZERO);
    functions[2] = CMLcreateArrayFunction(z2valencesJudd1951, CMLFALSE, CML_Z2VALENCES_JUDD1951_NUM, CML_Z2VALENCES_JUDD1951_MIN, CML_Z2VALENCES_JUDD1951_MAX, CML_INTERPOLATION_LINEAR, CML_EXTRAPOLATION_LINEAR_ZERO, CML_EXTRAPOLATION_LINEAR_ZERO);
    break;
  case CML_OBSERVER_2DEG_JUDD_VOS_1978:
    functions[0] = CMLcreateArrayFunction(x2valencesJuddVos1978, CMLFALSE, CML_X2VALENCES_JUDDVOS1978_NUM, CML_X2VALENCES_JUDDVOS1978_MIN, CML_X2VALENCES_JUDDVOS1978_MAX, CML_INTERPOLATION_LINEAR, CML_EXTRAPOLATION_LINEAR_ZERO, CML_EXTRAPOLATION_LINEAR_ZERO);
    functions[1] = CMLcreateArrayFunction(y2valencesJuddVos1978, CMLFALSE, CML_Y2VALENCES_JUDDVOS1978_NUM, CML_Y2VALENCES_JUDDVOS1978_MIN, CML_Y2VALENCES_JUDDVOS1978_MAX, CML_INTERPOLATION_LINEAR, CML_EXTRAPOLATION_LINEAR_ZERO, CML_EXTRAPOLATION_LINEAR_ZERO);
    functions[2] = CMLcreateArrayFunction(z2valencesJuddVos1978, CMLFALSE, CML_Z2VALENCES_JUDDVOS1978_NUM, CML_Z2VALENCES_JUDDVOS1978_MIN, CML_Z2VALENCES_JUDDVOS1978_MAX, CML_INTERPOLATION_LINEAR, CML_EXTRAPOLATION_LINEAR_ZERO, CML_EXTRAPOLATION_LINEAR_ZERO);
    break;
//  case CML_OBSERVER_2DEG_STILES_BURCH_1955:
//    functions[0] = new CMLArrayFunction(CML_X2VALENCES_STILESBURCH1955_MIN, CML_X2VALENCES_STILESBURCH1955_MAX, CMLArray(x2valencesStilesBurch1955, CMLFALSE, CML_X2VALENCES_STILESBURCH1955_NUM), CML_INTERPOLATION_LINEAR, CML_EXTRAPOLATION_LINEAR_ZERO);
//    functions[1] = new CMLArrayFunction(CML_Y2VALENCES_STILESBURCH1955_MIN, CML_Y2VALENCES_STILESBURCH1955_MAX, CMLArray(y2valencesStilesBurch1955, CMLFALSE, CML_Y2VALENCES_STILESBURCH1955_NUM), CML_INTERPOLATION_LINEAR, CML_EXTRAPOLATION_LINEAR_ZERO);
//    functions[2] = new CMLArrayFunction(CML_Z2VALENCES_STILESBURCH1955_MIN, CML_Z2VALENCES_STILESBURCH1955_MAX, CMLArray(z2valencesStilesBurch1955, CMLFALSE, CML_Z2VALENCES_STILESBURCH1955_NUM), CML_INTERPOLATION_LINEAR, CML_EXTRAPOLATION_LINEAR_ZERO);
//    break;
//  case CML_OBSERVER_2DEG_SHAW_FAIRCHILD_1997:
//    functions[0] = new CMLArrayFunction(CML_X2VALENCES_SHAWFAIRCHILD1997_MIN, CML_X2VALENCES_SHAWFAIRCHILD1997_MAX, CMLArray(x2valencesShawFairchild1997, CMLFALSE, CML_X2VALENCES_SHAWFAIRCHILD1997_NUM), CML_INTERPOLATION_LINEAR, CML_EXTRAPOLATION_LINEAR_ZERO);
//    functions[1] = new CMLArrayFunction(CML_Y2VALENCES_SHAWFAIRCHILD1997_MIN, CML_Y2VALENCES_SHAWFAIRCHILD1997_MAX, CMLArray(y2valencesShawFairchild1997, CMLFALSE, CML_Y2VALENCES_SHAWFAIRCHILD1997_NUM), CML_INTERPOLATION_LINEAR, CML_EXTRAPOLATION_LINEAR_ZERO);
//    functions[2] = new CMLArrayFunction(CML_Z2VALENCES_SHAWFAIRCHILD1997_MIN, CML_Z2VALENCES_SHAWFAIRCHILD1997_MAX, CMLArray(z2valencesShawFairchild1997, CMLFALSE, CML_Z2VALENCES_SHAWFAIRCHILD1997_NUM), CML_INTERPOLATION_LINEAR, CML_EXTRAPOLATION_LINEAR_ZERO);
//    break;
  default:
...
//}
//
//CMLAPI void CMLsetRadiometricComputation(CMLColorMachine* cm, CMLBool newradiometric){
...
CMLAPI void CMLsetObserverType(CMLColorMachine* cm, CMLObserverType newobservertype){
