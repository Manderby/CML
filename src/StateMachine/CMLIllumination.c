...
// Steps: 5nm
CMLHIDDEN static const float billuminant[] = {
...
// Their Use", 1931, Table V
// Steps: 5nm
CMLHIDDEN static const float cilluminant[] = {
...
// Steps: 5nm
CMLHIDDEN static const float f1illuminant[] = {
   ...
   19.55f, 15.48f, 14.91f, 14.15f, 13.22f, 12.19f, 11.12f, 10.03f,  8.95f,  7.96f,
    ...
    0.43f};
CMLHIDDEN static const float f2illuminant[] = {
  ...
  22.79f, 19.29f, 18.66f, 17.73f, 16.54f, 15.21f, 13.8f,  12.36f, 10.95f,  9.65f,
   ...
   0.27f};
CMLHIDDEN static const float f3illuminant[] = {
  ...
  24.69f, 21.41f, 20.85f, 19.93f, 18.67f, 17.22f, 15.65f, 14.04f, 12.45f, 10.95f,
   ...
   0.21f};
CMLHIDDEN static const float f4illuminant[] = {
  ...
  10.93f,  9.52f,  8.18f,  7.01f,  6.f,    5.11f,  4.36f,  3.69f,  3.13f,  2.64f,
   ...
   0.19f};
CMLHIDDEN static const float f5illuminant[] = {  // exactly the same numbers have been found in argyll
  ...
  19.5f,  15.39f, 14.64f, 13.72f, 12.69f, 11.57f, 10.45f,  9.35f,  8.29f,  7.32f,
   ...
   0.4f};
CMLHIDDEN static const float f6illuminant[] = {
  ...
  23.01f, 19.41f, 18.56f, 17.42f, 16.09f, 14.64f, 13.15f, 11.68f, 10.25f,  8.96f,
   ...
   0.21f};
CMLHIDDEN static const float f7illuminant[] = {
  ...
  10.76f, 10.42f, 10.11f, 10.04f, 10.02f, 10.11f,  9.87f,  8.65f,  7.27f,  6.44f,
   ...
   0.81f};
CMLHIDDEN static const float f8illuminant[] = {  // exactly the same numbers have been found in argyll
  ...
  14.2f,  14.16f, 14.13f, 14.34f, 14.5f,  14.46f, 14.f,   12.58f, 10.99f,  9.98f,
   ...
   1.32f};
CMLHIDDEN static const float f9illuminant[] = {
  ...
  14.72f, 14.55f, 14.4f,  14.58f, 14.88f, 15.51f, 15.47f, 13.2f,  10.57f,  9.18f,
   ...
   1.12f};
CMLHIDDEN static const float f10illuminant[] = {
  ...
  10.52f,  4.43f,  1.95f,  2.19f,  3.19f,  2.77f,  2.29f,  2.f,    1.52f,  1.35f,
   ...
   0.09f};
CMLHIDDEN static const float f11illuminant[] = {
  ...
  12.26f,  5.11f,  2.07f,  2.34f,  3.58f,  3.01f,  2.48f,  2.14f,  1.54f,  1.33f,
   ...
   0.09f};
CMLHIDDEN static const float f12illuminant[] = {
...
CMLHIDDEN static const float xenonilluminant[] = {
...
CMLHIDDEN static const float robertsonrt[] = {
  ...
  600.0e-6f};
CMLHIDDEN static const float robertsonu[] = {
  ...
  0.33724f};
CMLHIDDEN static const float robertsonv[] = {
  ...
  0.36051f};
CMLHIDDEN static const float robertsont[] = {
