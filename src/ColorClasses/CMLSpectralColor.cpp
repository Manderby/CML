...
//  if(bodycolor){
//    CMLRemissiontoGray(cmlcm, dest, spectrum, 1);
//  }else{
...
//  if(bodycolor){
//    CMLRadiometrictoXYZ (cmlcm, dest, spectrum, 1);
//  }else{
...
//  if(bodycolor){
//    CMLRemissiontoYuv (cmlcm, dest, spectrum, 1);
//  }else{
...
//  if(bodycolor){
//    CMLRemissiontoYupvp(cmlcm, dest, spectrum, 1);
//  }else{
...
//  if(bodycolor){
//    CMLRemissiontoYxy (cmlcm, dest, spectrum, 1);
//  }else{
...
//  if(bodycolor){
//    CMLRemissiontoLab (cmlcm, dest, spectrum, 1);
//  }else{
...
//  if(bodycolor){
//    CMLRemissiontoLch (cmlcm, dest, spectrum, 1);
//  }else{
...
//  if(bodycolor){
//    CMLRemissiontoLuv (cmlcm, dest, spectrum, 1);
//  }else{
...
//  if(bodycolor){
//    CMLRemissiontoRGB (cmlcm, dest, spectrum, 1);
//  }else{
...
//  if(bodycolor){
//    CMLRemissiontoYCbCr(cmlcm, dest, spectrum, 1);
//  }else{
...
//  if(bodycolor){
//    CMLRemissiontoHSV (cmlcm, dest, spectrum, 1);
//  }else{
...
//  if(bodycolor){
//    CMLRemissiontoHSL (cmlcm, dest, spectrum, 1);
//  }else{
...
//  if(bodycolor){
//    CMLRemissiontoCMYK(cmlcm, dest, spectrum, 1);
//  }else{
