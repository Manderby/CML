...
//    #ifndef NDEBUG
//      if(newu != MOB_UNIT_MOB){mobError("MOB unit has bad number.");}
//    #endif
//
//    newu = mobRegisterUnit(sizeof(MOBInt), "Int");
//    #ifndef NDEBUG
//      if(newu != MOB_UNIT_INT){mobError("Int unit has bad number.");}
//    #endif
//
//    newu = mobRegisterUnit(sizeof(float), "Float");
//    #ifndef NDEBUG
//      if(newu != MOB_UNIT_FLOAT){mobError("Float unit has bad number.");}
//    #endif
//
//    newu = mobRegisterUnit(sizeof(NAString), "String");
//    #ifndef NDEBUG
//      if(newu != MOB_UNIT_STRING){mobError("String unit has bad number.");}
//    #endif
//
//    newu = mobRegisterUnit(sizeof(MOBInt), "Enum");
//    #ifndef NDEBUG
//      if(newu != MOB_UNIT_ENUM){mobError("Enum unit has bad number.");}
//    #endif
//
//
//    newu = mobRegisterUnit(sizeof(MOB), "Array");
//    #ifndef NDEBUG
//      if(newu != MOB_UNIT_ARRAY){mobError("Array unit has bad number.");}
//    #endif
//
//
//
...
//  }
//  for(MOBInt i=0; i<naGetStackCount(&(context->unitpools)); i++){
...
//  #endif
//  
//  MOBInt newu = naGetStackCount(&(mobc->unitpools));
...
//    if(u >= naGetStackCount(&(mobc->unitpools)))
...
//  if(value){naCopyn((newmob->datacob->p), value, mob_GetUnitByteSize(u));}
//  return newmob;
//}
//
//
...
//  #endif
//  if(!mob){return;}
//  naCopyn(buf, (mob->datacob->p), mob_GetUnitByteSize(unitID));
//}
...
//      mobError("mobSetKeyUnitValue", "Object does not store the desired unit");
//  #endif
//  naCopyn((mob->datacob->p), buf, mob_GetUnitByteSize(unitID));
//}
//
//
